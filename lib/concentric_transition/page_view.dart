...
class ConcentricPageView
  ...
  const ConcentricPageView({
    ...
    this.curve =
        Curves.easeInOutSine, // const Cubic(0.7, 0.5, 0.5, 0.1),
  ...
  @override
  _ConcentricPageViewState createState() =>
      _ConcentricPageViewState();
}

class _ConcentricPageViewState
    extends
        State<
          ConcentricPageView
        > {
